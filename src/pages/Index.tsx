  ...
  const benefits = [
    {
      ...
      description: 'Получайте половину от каждой комиссии, которую приносит ваш клиент. Прозрачная и понятная система расчёта.'
    },
    {
      icon: 'Shield',
      title: 'Надёжность и опыт',
      description: 'Gx2Invest с 2006 года специализируется на индивидуальном доверительном управлении на основании лицензией Банка России. Является часть финансовой группы Gx2 с активами под управлением более 44 млрд.руб.'
    },
    {
      icon: 'Users',
    ...
    {
      icon: 'Smartphone',
      title: 'Онлайн открытие счета',
      description: 'Онлайн открытие счета для клиента через Личный кабинет. Отслеживание результатов управления'
    },
    {
      icon: 'GraduationCap',
      title: 'Обучение и поддержка',
      description: 'Проведем обучение, поможем с материалами для встречи с клиентом, предоставим офис для встречи в Москве и Екатеринбурге'
    },
    {
      icon: 'Award',
